...
<body>
  ...
  <div class="main-banner header-text" id="top">
    <div class="Modern-Slider">
      ...
      <?php
      require_once 'db.php';
      $query = "SELECT * FROM banners WHERE active_status=1 order by id desc LIMIT 2";
      $form_db = mysqli_query($db_connetion, $query);
      foreach ($form_db as $values) :
      ?>
        <div class="item item-1">
          <div class="img-fill" style="	background-image:url(<?= $values['image_location'] ?>);">
            <div class="text-content">
              <h6><?= $values['sub_title']; ?></h6>
              <h4><?= $values['title_top']; ?><br>&amp;<?= $values['title_bottom'] ?> </h4>
              <p><?= $values['details'] ?></p>
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="service-item">
            <img src="fontend/assets/images/service_01.jpg" alt="">
        ...
        <div class="col-md-4">
          <div class="service-item">
            <img src="fontend/assets/images/service_03.jpg" alt="">
            <div class="down-content">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="left-image">
                  <img src="fontend/assets/images/more-info.jpg" alt="">
                </div>
              </div>
              <div class="col-md-6 align-self-center">
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <div class="contact-form">
            <?php
            if (isset($_SESSION['guest_message_done'])) :
            ?>
              <h2> <small class="text-danger"> <?= $_SESSION['guest_message_done']; ?></small></h2>
            <?php
              unset($_SESSION['guest_message_done']);
            endif
            ?>
            <form id="contact" action="admin/guest_message_post.php" method="post">
              <div class="row">
                <div class="col-lg-4 col-md-12 col-sm-12">
                  ...
                  <?php
                  if (isset($_SESSION['guest_name_err'])) : ?>
                    <h2> <small class="text-danger"> <?= $_SESSION['guest_name_err']; ?></small></h2>
                  <?php
                ...
                <div class="col-lg-4 col-md-12 col-sm-12">
                  ...
                  <?php
                  if (isset($_SESSION['guest_email_err'])) :
                  ?>
                    <h2> <small class="text-danger"> <?= $_SESSION['guest_email_err']; ?></small></h2>
                  <?php
                ...
                <div class="col-lg-4 col-md-12 col-sm-12">
                  ...
                  <?php
                  if (isset($_SESSION['guest_subject_err'])) :
                  ?>
                    <h2> <small class="text-danger"> <?= $_SESSION['guest_subject_err']; ?></small></h2>
                  <?php
                    unset($_SESSION['guest_subject_err']);
                  endif
                  ?>
                </div>
                <div class="col-lg-12">
                  ...
                  <?php
                  if (isset($_SESSION['guest_message_err'])) :
                  ?>
                    <h2> <small class="text-danger"> <?= $_SESSION['guest_message_err']; ?></small></h2>
                  <?php
        ...
        <div class="col-md-12">
          <div class="owl-partners owl-carousel">
            ...
            <div class="partner-item">
              <img src="fontend/assets/images/client-01.png" title="1" alt="1">
            </div>

            <div class="partner-item">
              <img src="fontend/assets/images/client-01.png" title="2" alt="2">
            </div>

            <div class="partner-item">
              <img src="fontend/assets/images/client-01.png" title="3" alt="3">
            </div>

            <div class="partner-item">
              <img src="fontend/assets/images/client-01.png" title="4" alt="4">
            </div>

            <div class="partner-item">
              <img src="fontend/assets/images/client-01.png" title="5" alt="5">
            </div>
